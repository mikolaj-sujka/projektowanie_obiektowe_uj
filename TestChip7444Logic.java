...
public class TestChip7444Logic {
    ...
    public void chip7444ComponentLogic() throws UnknownChip, UnknownPin, ShortCircuitException, UnknownComponent, UnknownStateException {
        ...
        int chip = simulation.createChip(7444);
        ...
        states.add(new ComponentPinState(inputStrip, 3, PinState.HIGH));
    ...
    private void tableForChip7444(Map<Integer,Set<ComponentPinState>> states0List) {
        ...
        //1
        Set<ComponentPinState> statesSim1 = fillSet(PinState.LOW, PinState.HIGH, PinState.HIGH, PinState.LOW);
        states0List.put(1, statesSim1);
        //2
        Set<ComponentPinState> statesSim2 = fillSet(PinState.LOW, PinState.HIGH, PinState.HIGH, PinState.HIGH);
        states0List.put(2, statesSim2);
        //3
        Set<ComponentPinState> statesSim3 = fillSet(PinState.LOW, PinState.HIGH, PinState.LOW, PinState.HIGH);
        states0List.put(3, statesSim3);
        //4
        Set<ComponentPinState> statesSim4 = fillSet(PinState.LOW, PinState.HIGH, PinState.LOW, PinState.LOW);
        states0List.put(4, statesSim4);
        //5
        Set<ComponentPinState> statesSim5 = fillSet(PinState.HIGH, PinState.HIGH, PinState.LOW, PinState.LOW);
        states0List.put(5, statesSim5);
        //6
        Set<ComponentPinState> statesSim6 = fillSet(PinState.HIGH, PinState.HIGH, PinState.LOW, PinState.HIGH);
        states0List.put(6, statesSim6);
        //7
        Set<ComponentPinState> statesSim7 = fillSet(PinState.HIGH, PinState.HIGH, PinState.HIGH, PinState.HIGH);
        states0List.put(7, statesSim7);
        //8
        Set<ComponentPinState> statesSim8 = fillSet(PinState.HIGH, PinState.HIGH, PinState.HIGH, PinState.LOW);
        states0List.put(8, statesSim8);
        //9
        Set<ComponentPinState> statesSim9 = fillSet(PinState.HIGH, PinState.LOW, PinState.HIGH, PinState.LOW);
        states0List.put(9, statesSim9);
        //10 - always high or last state(7)
        Set<ComponentPinState> statesSim10 = fillSet(PinState.HIGH, PinState.LOW, PinState.HIGH, PinState.HIGH);
